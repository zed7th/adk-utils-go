...
- [ ] **OpenAI: no real-API (step B) run yet.** The schema step (A) passes and
      ...
      so far). Run `OPENAI_API_KEY=... go test -tags=integration ./genai/openai/completions/...`
